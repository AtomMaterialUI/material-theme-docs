...
|  [Images](#images) |  `.*\.(jpg\|png\|jpeg\|gif\|bmp) ` |  *.jpg<br>*.jpeg<br>*.png<br>*.gif<br>*.bmp |  ![Images](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/image.svg?sanitize=true) |
|  [webp](#webp) |  `.*\.webp$ ` |  *.webp |  ![webp](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/image.svg?sanitize=true) |
...
|  [1C](#1c) |  `.*\.(bsl\|sdbl\|os\|mdo)$ ` |  *.bsl<br>*.mdo<br>*.sbsl<br>*.os |  ![1C](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/1c.svg?sanitize=true) |
...
|  [Android Smali](#android-smali) |  `.*\.(smali\|rsh)$ ` |  *.smali<br>*.rsh |  ![Android Smali](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/android.svg?sanitize=true) |
...
|  [Assembly](#assembly) |  `.*\.(asm\|nasm\|inc\|ms\|agc\|aes\|aea\|arm\|avr\|argus\|mitigus)$ ` |  *.asm<br>*.nasm<br>*.inc<br>*.ms<br>*.agc<br>*.aes<br>*.aea<br>*.arm<br>*.avr<br>*.argus<br>*.mitigus |  ![Assembly](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/asm.svg?sanitize=true) |
...
|  [Avro](#avro) |  `.*\.(avcs\|avsc\|avdl) ` |  *.avcs<br>*.avsc<br>*.avdl |  ![Avro](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/avro.svg?sanitize=true) |
...
|  [Behat](#behat) |  `.*\.feature(\.php)?$ ` |  *.feature<br>*.feature.php |  ![Behat](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/behat.svg?sanitize=true) |
...
|  [Biml](#biml) |  `.*\.biml$ ` |  *.bim |  ![Biml](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/biml.svg?sanitize=true) |
...
|  [C](#c) |  `.*\.(c\|objc\|idc\|w\|nc\|upc\|cats)$ ` |  *.c<br>*.objc<br>*.idc<br>*.w<br>*.nc<br>*.upc<br>*.cats |  ![C](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/c.svg?sanitize=true) |
...
|  [C++](#c++) |  `.*\.(cpp\|c\+\+\|cc\|ii\|mii\|cxx\|ipp\|hpp)$ ` |  *.cpp<br>*.c++<br>*.cc<br>*.ii<br>*.mii<br>*.cxx<br>*.ipp<br>*.hpp |  ![C++](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/cpp.svg?sanitize=true) |
...
|  [DB](#db) |  `.*\.(db\|ddl)$ ` |  *.db<br>*.ddl |  ![DB](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/db.svg?sanitize=true) |
|  [Delphi](#delphi) |  `.*\.delphi$ ` |  *.delphi |  ![Delphi](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/delphi.svg?sanitize=true) |
|  [DLang](#dlang) |  `.*\.d$ ` |  *.d |  ![DLang](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/dlang.svg?sanitize=true) |
|  [Diff](#diff) |  `.*\.diff$ ` |  *.diff |  ![Diff](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/diff.svg?sanitize=true) |
...
|  [Dylib](#dylib) |  `.*\.dylib$ ` |  *.dylib |  ![Dylib](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/dylib.svg?sanitize=true) |
|  [Eclipse](#eclipse) |  `.*\.eclipse ` |  *.eclipse |  ![Eclipse](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/eclipse.svg?sanitize=true) |
...
|  [Emacs Lisp](#emacs-lisp) |  `^.*\.(el\|elc)$ ` |  *.el<br>*.elc |  ![Emacs Lisp](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/emacs.svg?sanitize=true) |
...
|  [ErLang](#erlang) |  `.*\.(erc\|erl\|erlang)$ ` |  *.erc<br>*.erl<br>*.erlang |  ![ErLang](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/erlang.svg?sanitize=true) |
...
|  [HTML](#html) |  `.*\.(html\|htm)$ ` |  *.html<br>*.htm |  ![HTML](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/html.svg?sanitize=true) |
...
|  [Idris](#idris) |  `.*\.(idr\|idris)$ ` |  *.idr<br>*.idris |  ![Idris](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/idris.svg?sanitize=true) |
|  [InDesign](#indesign) |  `.*\.(id\|indd\|indl\|indt\|indb\|idml)$ ` |  *.id<br>*.indd<br>*.indl<br>*.indt<br>*.indb<br>*.idml |  ![InDesign](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/indesign.svg?sanitize=true) |
|  [Istanbul](#istanbul) |  `.*\.nycrc(\.json)?$ ` |  *.nycrc.json<br>*.nycrc |  ![Istanbul](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/istanbul.svg?sanitize=true) |
|  [IO](#io) |  `.*\.(io)$ ` |  *.io |  ![IO](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/io.svg?sanitize=true) |
|  [Ionic](#ionic) |  `.*\.ionic\.config$ ` |  *.ionic.config |  ![Ionic](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/ionic.svg?sanitize=true) |
...
|  [Knockout](#knockout) |  `.*\.(knockout\|ko)$ ` |  *.knockout<br>*.ko |  ![Knockout](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/knockout.svg?sanitize=true) |
|  [Kotlin](#kotlin) |  `.*\.(kt\|kts\|kotlin)$ ` |  *.kt<br>*.kts<br>*.kotlin |  ![Kotlin](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/kotlin.svg?sanitize=true) |
...
|  [Makefile](#makefile) |  `.*\.?(m\|M)akefile$ ` |  Makefile<br>*.makefile |  ![Makefile](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/makefile.svg?sanitize=true) |
...
|  [Photoshop](#photoshop) |  `.*\.(psb\|psd)$ ` |  *.psb<br>*.psd |  ![Photoshop](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/psd.svg?sanitize=true) |
...
|  [Premiere](#premiere) |  `.*\.(prel\|prproj\|psq)$ ` |  *.prel<br>*.prproj<br>*.psq |  ![Premiere](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/premiere.svg?sanitize=true) |
...
|  [SQL](#sql) |  `.*\.(sql\|pdb\|pgsql\|mysql\|hql\|qml\|psql\|pkb)$ ` |  *.sql<br>*.pdb<br>*.pgsql<br>*.mysql<br>*.hql<br>*.qml<br>*.psql<br>*.pkb |  ![SQL](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/sql.svg?sanitize=true) |
...
|  [WebAssembly](#webassembly) |  `.*\.(wat\|wasm)$ ` |  *.wat<br>*.wasm |  ![WebAssembly](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/webassembly.svg?sanitize=true) |
...
|  [Windows](#windows) |  `.*\.(bat\|exe\|dos\|ms\|msi)$ ` |  *.bat<br>*.exe<br>*.dos<br>*.ms<br>*.msi |  ![Windows](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/windows.svg?sanitize=true) |
...
|  [Xamarin](#xamarin) |  `.*\.xamarin ` |  *.xamarin |  ![Xamarin](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/xamarin.svg?sanitize=true) |
...
|  [XCode Playground](#xcode-playground) |  `.*\.xcplayground$ ` |  *.xcplayground |  ![XCode Playground](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/appstore.svg?sanitize=true) |
|  [XCode Workspace](#xcode-workspace) |  `.*\.xcworkspace$ ` |  *.xcworkspace |  ![XCode Workspace](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/appstore.svg?sanitize=true) |
...
|  [XML](#xml) |  `.*\.(xml\|xhtml\|fxml\|jrxml\|jnlp\|pom\|rng\|tld\|wsdl\|xsd\|xsl\|xslt\|xul)$ ` |  *.xml<br>*.xhtml<br>*.fxml<br>*.jrxml<br>*.jnlp<br>*.pom<br>*.rng<br>*.tld<br>*.wsdl<br>*.xsd<br>*.xsl<br>*.xslt<br>*.xul |  ![XML](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/xml.svg?sanitize=true) |
...
|  [Audio (3)](#audio-(3)) |  `.*\.(ac3\|m4p\|f4a\|f4b\|it\|s3m)$ ` |  *.ac3<br>*.m4p<br>*.f4a<br>*.f4b<br>*.it<br>*.s3m |  ![Audio (3)](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/audio.svg?sanitize=true) |
...
|  [Javascript](#javascript) |  `.*\.(js\|es6\|es\|mjs)$ ` |  *.js<br>*.es6<br>*.es<br>*.mjs |  ![Javascript](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/js.svg?sanitize=true) |
...
|  [JSON](#json) |  `.*\.(json\|cson)$ ` |  *.json<br>*.cson |  ![JSON](https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/json.svg?sanitize=true) |
