...
The Material Theme plugin comes with a bunch of features tailored for an optimal experience. However, it is also highly configurable to allow every one to customize it to their hearts content.
{:class='title'}
