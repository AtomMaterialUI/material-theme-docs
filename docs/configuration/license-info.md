...
description: License details for Material Theme UI plugins.
group: configuration
toc: true
comments: true
...
- **Plugin Version**: The currently installed version of the plugin.
- **License Type**: Indicates whether you are using the **Free** or **Premium** version.
...
Material Theme UI offers two primary subscription models:
- **Free**: Provides access to core features at no cost.
- **Premium**: Unlocks the full suite of Material Theme UI features.
...
- [Material Theme Extras](https://plugins.jetbrains.com/plugin/19250-material-theme-ui-extras): Unlocks **Tabs**, **Trees**, **UI Components**, **Spacing**, and other premium customization options.
- [Material Theme Project Frame](https://plugins.jetbrains.com/plugin/19310-material-theme-ui-project-frame): Unlocks **Project Frame** customization.
- [Material Theme Custom Theme](https://plugins.jetbrains.com/plugin/19308-material-theme-ui-custom-theme): Unlocks **Custom Theme** and **Light Custom Theme** creation.
- [Material Theme Language Additions](https://plugins.jetbrains.com/plugin/19309-material-theme-ui-language-additions): Unlocks **Language Additions**.
...
{% include figure.html content="/screens/home.png" caption="Add-on Plugin Information" %}
