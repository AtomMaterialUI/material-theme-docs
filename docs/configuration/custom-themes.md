...
In order to use a custom theme, first you'll need to configure its colors. To do so open the Settings and navigate to
...
Here you can specify the name of your theme, an unique identifier, whether it's a dark theme and optionally a color
...
colors are best suited for an UI. However you can check out other famous Sublime/Atom/Visual Studio themes as an
...
purpose under the same color group. If though you'd like to have a different color for checkboxes and radio buttons, or
